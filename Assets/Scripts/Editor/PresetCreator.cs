...
public class PresetCreator
{
    ...
    public static void CreateAllPresets()
    {
        ...
        CreatePreset(dir, "Enemy_SkeletonSoldier", new CharacterPresetDef {
            name = "해골 졸병", isEnemy = true, rarity = StarGrade.Star1, body = "Skelton_1", eye = "Eye_Close",
        ...
        CreatePreset(dir, "Enemy_OrcScout", new CharacterPresetDef {
            name = "오크 보초", isEnemy = true, rarity = StarGrade.Star1, body = "Orc_1", eye = "Eye5",
        ...
        CreatePreset(dir, "Enemy_ZombieWanderer", new CharacterPresetDef {
            name = "좀비 방랑자", isEnemy = true, rarity = StarGrade.Star1, body = "Human_1", eye = "Eye_Close",
        ...
        CreatePreset(dir, "Enemy_SkeletonArcher", new CharacterPresetDef {
            name = "해골 궁수", isEnemy = true, rarity = StarGrade.Star1, body = "Skelton_1", eye = "Eye_Close",
            weapon = "Bow_1", cloth = "Cloth_7",
        ...
        CreatePreset(dir, "Enemy_OrcWarrior", new CharacterPresetDef {
            name = "오크 전사", isEnemy = true, rarity = StarGrade.Star1, body = "Orc_2", eye = "Eye6",
        ...
        CreatePreset(dir, "Enemy_SkeletonKnight", new CharacterPresetDef {
            name = "해골 전사", isEnemy = true, rarity = StarGrade.Star2, body = "Skelton_1", eye = "Eye_Close",
        ...
        CreatePreset(dir, "Enemy_UndeadGeneral", new CharacterPresetDef {
            name = "언데드 장군", isEnemy = true, rarity = StarGrade.Star3, body = "Skelton_1", eye = "Eye_Close",
        ...
        CreatePreset(dir, "Enemy_OrcChieftain", new CharacterPresetDef {
            name = "오크 족장", isEnemy = true, rarity = StarGrade.Star4, body = "Orc_1", eye = "Eye5",
        ...
        CreatePreset(dir, "Enemy_DesertSkeleton", new CharacterPresetDef {
            name = "사막 해골 검사", isEnemy = true, rarity = StarGrade.Star1, body = "Skelton_1", eye = "Eye_Close",
        ...
        CreatePreset(dir, "Enemy_DesertOrc", new CharacterPresetDef {
            name = "사막 오크 검사", isEnemy = true, rarity = StarGrade.Star1, body = "Orc_3", eye = "Eye7",
        ...
        CreatePreset(dir, "Enemy_MummySoldier", new CharacterPresetDef {
            name = "미라 졸병", isEnemy = true, rarity = StarGrade.Star1, body = "Human_3", eye = "Eye_Close",
            weapon = "Sword_1", shield = "Sword_2", cloth = "Cloth_10",
        ...
        CreatePreset(dir, "Enemy_DesertGhost", new CharacterPresetDef {
            name = "사막 유령", isEnemy = true, rarity = StarGrade.Star1, body = "Elf_2", eye = "Eye8",
            weapon = "Ward_1", cloth = "Cloth_3",
        ...
        CreatePreset(dir, "Enemy_DesertDarkKnight", new CharacterPresetDef {
            name = "사막 전사", isEnemy = true, rarity = StarGrade.Star2, body = "Human_3", eye = "Eye3",
        ...
        CreatePreset(dir, "Enemy_MummyMage", new CharacterPresetDef {
            name = "미라 법사", isEnemy = true, rarity = StarGrade.Star2, body = "Human_5", eye = "Eye_Close",
            weapon = "Ward_1", cloth = "Cloth_9", back = "Back_1",
            bodyColor = new Color(0.8f, 0.75f, 0.6f),
        ...
        CreatePreset(dir, "Enemy_DesertGuardian", new CharacterPresetDef {
            name = "사막 수호자", isEnemy = true, rarity = StarGrade.Star3, body = "Orc_4", eye = "Eye7",
        ...
        CreatePreset(dir, "Enemy_PharaohUndead", new CharacterPresetDef {
            name = "파라오 언데드", isEnemy = true, rarity = StarGrade.Star4, body = "Skelton_1", eye = "Eye_Close",
        ...
        CreatePreset(dir, "Enemy_CaveSkeleton", new CharacterPresetDef {
            name = "동굴 해골 검사", isEnemy = true, rarity = StarGrade.Star1, body = "Skelton_1", eye = "Eye_Close",
        ...
        CreatePreset(dir, "Enemy_CaveBat", new CharacterPresetDef {
            name = "동굴 박쥐", isEnemy = true, rarity = StarGrade.Star1, body = "Devil_1", eye = "Eye8",
        ...
        CreatePreset(dir, "Enemy_FungusZombie", new CharacterPresetDef {
            name = "독버섯 좀비", isEnemy = true, rarity = StarGrade.Star1, body = "Human_2", eye = "Eye_Close",
            weapon = "Sword_4", shield = "Sword_1", cloth = "Cloth_11",
        ...
        CreatePreset(dir, "Enemy_CaveOrc", new CharacterPresetDef {
            name = "동굴 오크 검사", isEnemy = true, rarity = StarGrade.Star1, body = "Orc_2", eye = "Eye6",
        ...
        CreatePreset(dir, "Enemy_CaveGolem", new CharacterPresetDef {
            name = "동굴 골렘", isEnemy = true, rarity = StarGrade.Star3, body = "Orc_4", eye = "Eye_Close",
        ...
        CreatePreset(dir, "Enemy_PoisonMage", new CharacterPresetDef {
            name = "독 마법사", isEnemy = true, rarity = StarGrade.Star2, body = "Elf_1", eye = "Eye2",
        ...
        CreatePreset(dir, "Enemy_CaveWarden", new CharacterPresetDef {
            name = "동굴 수호자", isEnemy = true, rarity = StarGrade.Star3, body = "Orc_4", eye = "Eye_Close",
        ...
        CreatePreset(dir, "Enemy_SubterraneanLord", new CharacterPresetDef {
            name = "지하 군주", isEnemy = true, rarity = StarGrade.Star4, body = "Devil_1", eye = "Eye8",
        ...
        CreatePreset(dir, "Enemy_LavaOrc", new CharacterPresetDef {
            name = "용암 오크", isEnemy = true, rarity = StarGrade.Star1, body = "Orc_3", eye = "Eye7",
        ...
        CreatePreset(dir, "Enemy_LavaMage", new CharacterPresetDef {
            name = "용암 법사", isEnemy = true, rarity = StarGrade.Star2, body = "Devil_1", eye = "Eye8",
        ...
        CreatePreset(dir, "Enemy_FlameGeneral", new CharacterPresetDef {
            name = "화염 장군", isEnemy = true, rarity = StarGrade.Star3, body = "Orc_3", eye = "Eye7",
        ...
        CreatePreset(dir, "Enemy_VolcanoLord", new CharacterPresetDef {
            name = "화산 군주", isEnemy = true, rarity = StarGrade.Star4, body = "Devil_1", eye = "Eye8",
        ...
        CreatePreset(dir, "Enemy_DarkSkeleton", new CharacterPresetDef {
            name = "암흑 해골 검사", isEnemy = true, rarity = StarGrade.Star1, body = "Skelton_1", eye = "Eye_Close",
        ...
        CreatePreset(dir, "Enemy_DarkKnight", new CharacterPresetDef {
            name = "암흑 전사", isEnemy = true, rarity = StarGrade.Star2, body = "Skelton_1", eye = "Eye_Close",
            weapon = "Sword_6", armor = "Armor_5", shield = "Shield_1",
        ...
        CreatePreset(dir, "Enemy_DeathKnight", new CharacterPresetDef {
            name = "죽음의 기사", isEnemy = true, rarity = StarGrade.Star3, body = "Skelton_1", eye = "Eye_Close",
